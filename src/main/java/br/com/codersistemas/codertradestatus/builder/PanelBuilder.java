package br.com.codersistemas.codertradestatus.builder;
 ...
 * 
 * JPanel panel1 = ui.row().add(new JLabel("Nome")).row().add(new JTextField(20)).row().add(new JLabel("Email"))
 * 		.add(new JLabel("Nascimento")).row().add(new JTextField(20)).add(new JFormattedTextField(20)).row()
 * 		.add(new JCheckBox("ADM")).add(new JCheckBox("SYS")).add(new JCheckBox("CLR")).add(new JCheckBox("GER"))
 * 		.add(new JCheckBox("JUR")).row().add(new JButton("Novo")).add(new JButton("Salvar"))
 * 		.add(new JButton("Excluir")).build();
 * </pre>
 * 
 * @author gustavo
 *
